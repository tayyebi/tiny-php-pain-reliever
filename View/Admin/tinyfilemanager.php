<?php
// TYYI START Added Header
if (isset($_POST['fm_usr'], $_POST['fm_pwd']))
{
    $_SERVER['PHP_AUTH_USER'] = $_POST['fm_usr'];
    $_SERVER['PHP_AUTH_PW'] = $_POST['fm_pwd'];
}
...
$root_path = $_SERVER['DOCUMENT_ROOT'] .'/download';
    ...
    */
    ...
    // TYYI END
    {
        ...
        if(function_exists('password_verify')) {
            ...
            // TYYI START Original Login Function
