...
CREATE TABLE `sariab_data`.`Podcasts` ( `Id` INT NOT NULL AUTO_INCREMENT , `EpisodeNumber` VARCHAR(5) NOT NULL , `PublishDate` VARCHAR(20) NOT NULL , `Title` VARCHAR(300) NOT NULL , `About` LONGTEXT NOT NULL , `FileUrl` VARCHAR(3000) NOT NULL , PRIMARY KEY (`Id`)) ENGINE = InnoDB;